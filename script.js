const movies = [
    ...
    },
    {
      ...
      "popularity": 937.385,
      "vote_average": 7.1,
      "overview": "A dethroned queen bee at a posh private high school strikes a secret deal with an unassuming new student to enact revenge on one anothe's enemies.",
...
function searchMovies (title = '', keyword = '') {
  ...
  keywordBersih = keyword.trim()
  keywordBersih = keywordBersih.toLowerCase()

  titleBersih = title.trim()
  titleBersih = titleBersih.toLowerCase()
  
  isIncludes = titleBersih.includes(keywordBersih)
...
function getMovies(keyword = ''){
  let result = []
  let film = keyword.trim().toLowerCase()
